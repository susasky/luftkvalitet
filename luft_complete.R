...
m1$save("chart_noco.html")

######

#working on pm

pm$PM_10<-as.numeric(pm$PM_10)
pm$PM_25<-as.numeric(pm$PM_25)
pm <- transform(pm, date_2015=as.character(date_2015))

p1 <- mPlot(x="date_2015", y=c("PM_10","PM_25"), type = "Line", data = pm)
p1$set(pointSize = 2, lineWidth = 1)
p1$save("chart_pm.html")
